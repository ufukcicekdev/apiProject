from fastapi import FastAPI, HTTPException, Request, Header, Request, Query, APIRouter
...
@router.get("/get_data_date_range_by_domain" )
...
@router.get("/get_data_by_date_and_domain")
async def get_data_by_date(
    api_key: str = Header(...),
    create_date: str = Query(
        ...,  # Buraya başlangıç değerini ekleyebilirsiniz
